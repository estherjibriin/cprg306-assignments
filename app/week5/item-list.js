...
import Item from "./item"; // Make sure the filename matches the actual filename
import Heading from "./heading"; // Make sure the filename matches the actual filename
